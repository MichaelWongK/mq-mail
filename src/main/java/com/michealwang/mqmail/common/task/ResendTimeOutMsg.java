    ...
    public void ResendTimeOutMsg() {
        ...
        msgLogs.forEach(msgLog -> {
            ...
            if (msgLog.getTryCount() >= 3) {
                ...
                rabbitTemplate.convertAndSend(msgLog.getExchange(), msgLog.getRoutingKey(), MessageHelper.objToMsg(JsonUtil.strToObj(msgLog.getMsg(), LoginLog.class)), correlationData);
